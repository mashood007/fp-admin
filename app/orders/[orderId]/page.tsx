    ...
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mt-8 overflow-hidden rounded-lg bg-white shadow">
                <div className="px-4 py-5 sm:px-6">
                    <h3 className="text-base font-semibold leading-6 text-gray-900">Delivery Status</h3>
                    {order.deliveryOrder && (
                ...
                <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
                    {order.deliveryOrder ? (
                        <DeliveryTracking awb={order.deliveryOrder.airwayBillNumber} />
                    ) : (
...
async function DeliveryTracking({ awb }: { awb: string }) {
    const trackingData = await getTracking(awb);
